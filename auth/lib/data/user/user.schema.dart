...
class UserInsertRequest {
  UserInsertRequest({required this.username, required this.email, required this.password});
...
class UserUpdateRequest {
  UserUpdateRequest({required this.id, this.username, this.email, this.password});
...
class UserView {
  UserView({required this.id, required this.username, required this.email, required this.password});
